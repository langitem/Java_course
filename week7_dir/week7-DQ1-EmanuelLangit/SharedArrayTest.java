...
public class SharedArrayTest
{
   public static void main( String[] arg )
   {
      ...
      ArrayWriter writer1 = new ArrayWriter( 'a', sharedSimpleArray ); // change 1 to a character
      ArrayWriter writer2 = new ArrayWriter( 'k', sharedSimpleArray ); // change 11 to k character
